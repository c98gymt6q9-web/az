...
# ========== КОНФИГУРАЦИЯ ==========
class Config:
    # Telegram - ТОКЕН ВШИТ В КОД
    TOKEN = "8734739816:AAFn6rmvlsiZnvlgzSbIuMcF8sGw0g4ctls"

    # Google
    GOOGLE_FOLDER_ID = "1hj2gT5iRhY67MWHoaYyZ8dSQQMaUYtnf"
    ...
    # Платежи
    PAYMENT_METHOD = "Альфа банк"
    PAYMENT_ACCOUNT = "Альфа банк"
    PAYMENT_NAME = "Арсений Хабибуллин"
    PAYMENT_PHONE = "+79875146160"
